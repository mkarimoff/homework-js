...
import { Body, Body2,  Bottom,  BottomDivs,  DetailCon, DivsWrap, Header, SubHead, TextWrap, Title1 } from '../pages/menu/menustyle.js';
...
const MenuDetail = () => {
  let { id } = useParams();
  console.log("detail:",MenuList)
  const data = MenuList.find((value)=> value.id == parseFloat(id));
  console.log(id);
